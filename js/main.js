...
var MazeWorld = function() {
  ...
  if ( havePointerLock ) {
    ...
    var onClickAnswer = function( event ) {
      ...
      loadMazeData( serverBase+"/room" + _door_url + "/?format=json&key=" + _key, function( data ) {
  ...
  function initialize() {
    ...
    g_scene.add( g_player );
      ...
      // test();
      loadMazeData( serverBase+"/room/home/?format=json", function( data ) {
  ...
  function ajax_test() {
    var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", serverBase+"/room/home/?format=json", true);
